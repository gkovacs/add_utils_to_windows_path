...
addpathifneeded "c:\program files (x86)\git\bin\git.exe" "git"
addpathifneeded "c:\program files\git\bin\git.exe" "git"
addpathifneeded "c:\program files (x86)\git\bin\ssh.exe" "ssh"
addpathifneeded "c:\program files\git\bin\ssh.exe" "ssh"
addpathifneeded "c:\program files (x86)\git\bin\bash.exe" "bash"
addpathifneeded "c:\program files\git\bin\bash.exe" "bash"
addpathifneeded "c:\program files (x86)\microsoft vs code\code.exe" "code"
addpathifneeded "c:\program files\microsoft vs code\code.exe" "code"
pause